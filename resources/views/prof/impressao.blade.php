...
@section('content')
  ...
  <main class="prof">
    ...
    <table>
      ...
      @foreach($profs as $p)
        <tr class="tabela-item">
          ...
          <td>{{ $p->projeto }}</td>
          <td>
            <a href="#" class="btn btn-imprimir" title="Imprimir folha de ponto" data-id="{{$p->id}}" onclick="mostrarModal()"><i class="fas fa-print"></i></a>
          </td>
        </tr>
      @endforeach
      </tbody>
    ...
    <a href="#" id="btnMostrarModal" class="btn btn-imprimir-tudo" data-id="0" title="Imprimir tudo"><i class="fas fa-print"></i></a>  </main>
